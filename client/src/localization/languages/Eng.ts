...
export default {
  ...
  com_ui_date_sign_up: 'Sign up Date',
  com_ui_date_update: 'Update Date',
  ...
  com_ui_set_to_admin: 'Set as admin',
  com_ui_set_to_user: 'Set as user',
  ...
  com_users_filter: 'Filter users...',
  com_users_filter_email: 'Filter users by email...',
  com_ui_delete_success: 'Delete successful',
  com_ui_delete_error: 'Delete failed',
  com_ui_update_success: 'Update successful',
  com_ui_update_error: 'Update failed',
  com_ui_set_confirm: 'Are you sure you want to proceed with this action?',
  com_ui_delete_select_users: 'Are you sure you want to delete the selected users? This action will delete all conversations, files, etc., associated with these users.',
  com_auth_reset_password_error: 'Failed to reset the password. Please try again or contact the administrator!',
  com_auth_update_error: 'Operation failed. Please try again or contact the administrator!',
  com_nav_users_add: 'Add user',
  com_nav_user_add_error: 'Failed to add user. Please try again or contact the administrator!',
